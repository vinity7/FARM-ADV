...
export default function AIChat() {
  ...
  const handleSendMessage = (text: string, image?: string) => {
    ...
    setTimeout(() => {
      let aiText = "I've received your query.";
      if (image) {
        aiText = "Analyzing crop photo... Looks like **Tomato Leaf Curl Virus**. Recommended: Remove infected plants and apply neem oil. Avoid excessive nitrogen.";
      } else if (text.toLowerCase().includes('rain') || text.toLowerCase().includes('മഴ')) {
        aiText = "Tomorrow, Palakkad expects moderate rainfall (15mm). Ensure proper drainage for your coconut groves.";
      } else {
        aiText = "Here is some advice on your query. [AI Response placeholder for demo]";
      }
